...
pub struct ModelregistryservicesetregisteredmodeltagRequest {
...
impl ModelregistryservicesetregisteredmodeltagRequest {
    pub fn new(name: String, key: String, value: String) -> ModelregistryservicesetregisteredmodeltagRequest {
