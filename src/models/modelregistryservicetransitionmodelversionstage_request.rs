...
pub struct ModelregistryservicetransitionmodelversionstageRequest {
...
impl ModelregistryservicetransitionmodelversionstageRequest {
    pub fn new(name: String, version: String, stage: String, archive_existing_versions: bool) -> ModelregistryservicetransitionmodelversionstageRequest {
