...
pub struct ModelregistryservicesetmodelversiontagRequest {
...
impl ModelregistryservicesetmodelversiontagRequest {
    pub fn new(name: String, version: String, key: String, value: String) -> ModelregistryservicesetmodelversiontagRequest {
